...
Generated: 2026-09-23 21:28 by `tools/calibration_report.py`. Analysis only: nothing here changes scoring.

## Inputs

- curated pairs: `claude/experimental_interactions_curated.csv`
- negatives: `claude/calibration/af3_negatives_MA_4115.csv`
- results workbook: `claude/calibration/2026-09-23_rockhopper_default/calib_results_rockhopper_true.xlsx`
- run provenance (`calib_results_rockhopper_true.run_provenance.yaml`):
  - config hash: `92f8c4aa`
  - code: 5.0 (git 6f6f988)
  - reference genome check: passed
  - generated: 2026-09-23T21:19:47
...
|---|---|---|---|
| `interaction_score` | 20, 33.58 / 32.51 | 35, 28.34 / 22.13 | 21, 9.70 / 6.14 |
| `interaction_priority_score` | 20, 54.71 / 56.15 | 35, 55.42 / 54.94 | 21, 27.95 / 28.52 |
...
| `final_score` | 20, 44.75 / 46.09 | 35, 41.98 / 38.82 | 21, 26.15 / 25.14 |
...
|---|---:|---:|---:|---:|
| `interaction_score` | 0.938 | <0.001 (asymptotic) | 0.737 | 0.003 (asymptotic) |
...
| `final_score` | 0.900 | <0.001 (asymptotic) | 0.778 | <0.001 (asymptotic) |
